...
use Modules\AdministratorRole\Application\Admin\Controllers\AdministratorPermissionController as AdminAdministratorPermissionController;
...
Route::middleware([])->name('AdministratorRole.')->group(function () {
    Route::prefix('admin')->name('Admin.')->group(function () {
        ...
        Route::controller(AdminAdministratorPermissionController::class)->prefix('administrator-permissions')->name('AdministratorPermission.')->group(function () {
            Route::get('', 'index')->name('index');
            Route::post('', 'store')->name('store');
            Route::get('{id}', 'show')->name('show');
            Route::put('{id}', 'update')->name('update');

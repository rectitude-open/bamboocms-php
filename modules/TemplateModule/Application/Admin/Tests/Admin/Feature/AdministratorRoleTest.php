...
require_once __DIR__.'/TemplateModuleDataset.php';

beforeEach(function () {
    $this->routes = [
        'index' => 'TemplateModule.Admin.TemplateModule.index',
        'store' => 'TemplateModule.Admin.TemplateModule.store',
        'show' => 'TemplateModule.Admin.TemplateModule.show',
        'update' => 'TemplateModule.Admin.TemplateModule.update',
        'destroy' => 'TemplateModule.Admin.TemplateModule.destroy',
        'bulkDestroy' => 'TemplateModule.Admin.TemplateModule.bulkDestroy',
    ];
    $this->modelClass = TemplateModule::class;
